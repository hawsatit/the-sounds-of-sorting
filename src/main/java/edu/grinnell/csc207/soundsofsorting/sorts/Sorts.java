...
public class Sorts {
    ...
    /**
     * This helper function recursively breaks down the left side of the array
     * and right side of the array and then merges it back up.
     *
     * @param <T>
     * @param arr the array to sort
     * @param left The left bound of the subarray we want to sort
    ...
    /**
     * Splits into two by using bounds recursively, while using the quick sort
     * method of comparison using pivot points
     *
     * @param <T> the carrier type of the array
     * @param arr the array to sort
    ...
    /**
     * making the pivot the right most element and using the pivot comparison
     * from the quick sort method
     *
     * @param <T> the carrier type of the array
     * @param arr the array to sort
     * @param left left bound of the subarray
