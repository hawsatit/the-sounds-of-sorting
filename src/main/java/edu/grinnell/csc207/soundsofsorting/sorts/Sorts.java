...
public class Sorts {
     ...
     * @param events
     */
    public static <T extends Comparable<? super T>> void merge(T[] arr, int left, int right, 
            int mid, List<SortEvent<T>> events) {
     ...
     * @param events
     */
    public static <T extends Comparable<? super T>> void mergeSortRecursion(T[] arr, int left, 
            int right, List<SortEvent<T>> events) {
     ...
     * @param events
     */
    public static <T extends Comparable<? super T>> void quickSortRecursion(T[] arr, int left, 
            int right, List<SortEvent<T>> events) {
     ...
     */
    public static <T extends Comparable<? super T>> int pivotCompare(T[] arr, int left, 
            int right, List<SortEvent<T>> events) {
     ...
     * @param events
     */
    public static <T extends Comparable<? super T>> void makeHeap(T[] arr, int n, 
            int root, List<SortEvent<T>> events) {
        int largest = root;
        int left = 2 * root + 1;
        int right = 2 * root + 2;
    ...
    /**
     * Applies the events in order to sort the array.
     *
     * @param <T> the carrier type of the array
